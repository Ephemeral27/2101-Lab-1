...
public class BookTest {
    ...
    void invalidAdjacentYear() {
        assertThrows(IllegalArgumentException.class, () -> new Book("1234567890211", "Aloha", "Oumou", 7900, 1449));
    ...
    void malformedIdentifiers() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new Book("ABCDEFGHLM", "Me", "She", 4567, 2014));
